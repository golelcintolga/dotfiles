...
# polybar ---------------------------------
sed -i -e 's/bg = .*/bg = #F9F5D7/g' $polybar_path/colors.ini
sed -i -e 's/bg-alt = .*/bg-alt = #D5C4A1/g' $polybar_path/colors.ini
sed -i -e 's/fg = .*/fg = #3C3836/g' $polybar_path/colors.ini
