...
## Dirs
polybar_path="$HOME/.config/polybar/bspwm/bar_double"
...
sed -i -e 's/@import .*/@import "colors\/gruvbox-dark-hard.rasi"/g' /home/tolga/.config/rofi/themes/colors/00color-choice.rasi
...
sed -i -e 's/@import .*/@import "colors\/gruvbox-light-hard.rasi"/g' /home/tolga/.config/rofi/themes/colors/00color-choice.rasi
## Help Menu #############################################
else
echo "
Style Switcher
